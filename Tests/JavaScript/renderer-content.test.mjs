...
} from '../../Sources/LakeOfFireReader/Resources/foliate-js/renderer-content.js'
...
test('invalid or throwing currentIndex access does not hide usable content', () => {
...
test('authoritative currentIndex excludes unindexed auxiliary and stale contents', () => {
...
test('an explicit document is accepted only while it remains primary', () => {
