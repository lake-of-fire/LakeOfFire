"""Actual viewer-shell E2E with a generated EPUB and simulated native persistence.
The real viewer, paginator, controls, end page and reply dispatcher run. This
is not a Realm, CloudKit, SwiftUI or WKWebView-admission qualification.
"""
...
BRIDGE = '''(() => {
    ...
    for (const name of ['ebookViewerInitialized','ebookViewerLoaded','markSectionAsRead',
        ...
        'markAllSectionsAsRead','finishedReadingBook','startOver',
...
class BookEndcapShellTests(unittest.TestCase):
    ...
    def test_actual_viewer_end_page_does_not_mark_skipped_content(self):
        ...
        # Production native setup completes the saved-position handshake even
        # for a new book. Do not force-hide its loading cover in this test.
