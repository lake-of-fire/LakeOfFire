...
final class readium_opds1_1_test: XCTestCase {
    ...
    func testXHTMLTitleRetainsNestedEmptyAndMixedText() throws {
        let url = try XCTUnwrap(URL(string: "https://example.com/catalog"))
        ...
        <feed xmlns="http://www.w3.org/2005/Atom">
          ...
          <entry>
            ...
            <updated>2026-09-07T00:00:00Z</updated>
            <title type="xhtml">
              <div xmlns="http://www.w3.org/1999/xhtml">A <span/><b>Book</b> Title</div>
            </title>
        ...
        let result = try OPDS1Parser.parse(
