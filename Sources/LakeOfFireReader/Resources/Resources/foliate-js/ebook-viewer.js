...
class Reader {
    ...
    async performLookupNavigationPageTurn(request = {}) {
        ...
        return {
            // Boundary navigation is deliberately a single page turn. Reopening a
            // lookup after a section load races the renderer and leaves the old
            // popover presentation in an indeterminate state.
            opened: false,
            pageTurnAttempted: true,
