...
/// Since LakeOfFireReader is a static library, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "LakeOfFire_LakeOfFireReader"
        ...
        fatalError("unable to find bundle named LakeOfFire_LakeOfFireReader")
    }()
}
